        ...
        if (existsSync(assetsDir)) {
          ...
          if (constantsFile) {
            ...
            if (constMatch) {
              ...
              const constantsDecl = `const EXTENSION_VERBOSE_LOGS=!1,YOUTUBE_HOSTNAME="www.youtube.com",YOUTUBE_WATCH_PATH="/watch",METADATA_CACHE_TTL=3e5,CONFIDENCE_THRESHOLD=.5,MESSAGE_TYPES={GENERATE_RULES:"GENERATE_RULES",GET_RULES:"GET_RULES",GET_ACTIVE_RULES:"GET_ACTIVE_RULES",SAVE_RULE:"SAVE_RULE",TOGGLE_RULE:"TOGGLE_RULE",DELETE_RULE:"DELETE_RULE",CHECK_METADATA:"CHECK_METADATA",GET_YOUTUBE_OEMBED_METADATA:"GET_YOUTUBE_OEMBED_METADATA",REDIRECT_TO_BLOCKED:"REDIRECT_TO_BLOCKED"},ALARM_NAMES={EVALUATE_RULES:"evaluateRules"},STORAGE_KEYS={RULES:"rules"},DAY_NAMES=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],NAVIGATION_CHECK_DELAY=1e3;`;
